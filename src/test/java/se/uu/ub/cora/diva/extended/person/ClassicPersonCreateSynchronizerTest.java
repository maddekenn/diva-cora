...
public class ClassicPersonCreateSynchronizerTest {
	...
	public void setUp() {
		...
		functionality = new ClassicPersonCreateSynchronizer(classicFedoraUpdaterFactory,
	...
	private void assertCorrectCallToUpdater(DataGroup person) {
		...
		assertEquals(classicUpdater.methodName, "createInFedora");
	}
